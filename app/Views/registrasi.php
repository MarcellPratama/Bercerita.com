...
<body>
    ...
    const asalUnivInput = document.getElementById('asal_univ');
    const ktmUpload = document.getElementById('ktm-upload');
    const domisiliInput = document.getElementById('domisili');
    const ktpFileInput = document.getElementById('ktp-upload');
    const licenseFileInput = document.getElementById('license-upload');

    // Hapus pesan error saat pengguna mulai mengetik di kolom username
    usernameInput.addEventListener('input', () => {
        hideGlobalError(); // Sembunyikan pesan error global saat mengetik di username
    });
    ...
    // Hapus pesan error saat pengguna memilih kategori
    categorySelect.addEventListener('change', () => {
        hideGlobalError(); // Sembunyikan pesan error global saat memilih kategori
    });
    fileUploadInput.addEventListener('change', function() {
        hideGlobalError(); // Sembunyikan pesan error global saat memilih file
    });
    nimInput.addEventListener('input', function() {
        hideGlobalError(); // Sembunyikan pesan error global saat mengetik di NIM
    });

    // Menyembunyikan pesan error ketika pengguna mulai mengetik di kolom asal_univ
    asalUnivInput.addEventListener('input', function() {
        hideGlobalError(); // Sembunyikan pesan error global saat mengetik di Asal Universitas
    });

    // Menyembunyikan pesan error ketika pengguna memilih file untuk upload
    ktmUpload.addEventListener('change', function() {
        hideGlobalError(); // Sembunyikan pesan error global saat memilih file KTM
    });
    domisiliInput.addEventListener('input', function() {
        hideGlobalError(); // Sembunyikan pesan error global saat mengetik di domisili
    });

    // Menyembunyikan pesan error saat memilih file KTP
    ktpFileInput.addEventListener('change', function() {
        hideGlobalError(); // Sembunyikan pesan error global saat memilih file KTP
    });

    // Menyembunyikan pesan error saat memilih file Lisensi
    licenseFileInput.addEventListener('change', function() {
        hideGlobalError(); // Sembunyikan pesan error global saat memilih file Lisensi
    });
