...
<body>
    <div class="menu">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear gear-icon" viewBox="0 0 16 16" onclick="window.location.href='<?= base_url('mahasiswa/edit') ?>'">
        ...
        <table>
            <?php foreach ($forums as $forum): ?>
                <tr>
                    ...
                    <td>
                        <?php if (!empty($forum['foto'])): ?>
                            <img src="<?= base_url($forum['foto']) ?>" width="50" height="50">
                        <?php else: ?>
