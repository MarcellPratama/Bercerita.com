...
<body>
    ...
    <div class="container mt-3">
        <div class="row">
            <!-- Chat Sidebar (List Member) -->
            <div class="col-md-3 bg-light border-end p-3">
                <h5 class="mb-3 fw-bold">Ruang Cerita</h5>
                <ul class="list-group list-group-flush">
                    <?php if (isset($forums) && !empty($forums)): ?>
                            ...
                            <li class="list-group-item" style="background-color: #2A6F97;">
                                <a class="forum-link"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="me-2">
                                                <img src="<?= base_url($forum['foto']) ?>" class="rounded-circle" style="width: 50px; height: 50px; object-fit: cover;">
                                            </div>
                                        </div>
                                        <div class="col-md-8 align-self-center" style="color: #f6f6f6;">
                                            <?= esc($forum['nama_forum']) ?>
                                        </div>
                                    </div>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <li class="list-group-item text-muted">Belum tergabung di forum mana pun.</li>
                    <?php endif; ?>
                </ul>
            </div>
