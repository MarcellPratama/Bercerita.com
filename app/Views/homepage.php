...
<body>
    ...
    <div class="background-1" id="ruangCerita">
        <div class="container my-5">
            ...
            <div class="text-center">
                <button onclick="location.href='/login'" class="btn btn-primary mt-3">Lihat Lebih Banyak</button>
            </div>
        </div>
    </div>
    ...
    <div class="background-2" id="jejakPerasaan">
        <div class="container my-5">
            ...
            <div class="text-center mt-4">
                <button onclick="location.href='/login'" class="btn btn-primary mt-3">Ayo! Tinggalkan Jejak Perasaanmu</button>
            </div>
        </div>
    ...
    <div class="background-4" id="konsultasi">
        <div class="container my-5">
            ...
            <div class="text-center mt-4">
                <button onclick="location.href='/login'" class="btn btn-primary mt-3">Lihat Semua</button>
            </div>
        </div>
    </div>
