...
<body>
    ...
    <div class="profile_container">
        ...
        <div class="profile_pic">
            <img id="profile-image" src="<?= isset($data['foto']) ? base_url($data['foto']) : base_url('path/to/default-profile.png') ?>" alt="Foto Profil">
        </div>
        <input type="file" id="file-input" style="display: none;" accept="image/*" name="profile_pic" onchange="previewImage(event)">
    ...
    <div class="form_container">
        <form action="<?= base_url('mahasiswa/updateProfile') ?>" method="POST" enctype="multipart/form-data" onsubmit="return validateForm(this)">
            ...
            <div class="form_group">
                ...
                <img class="eye-icon" id="eye-icon" src="<?= base_url('Images/close.png') ?>" alt="Eye Icon" onclick="togglePasswordVisibility()">
            </div>
            <div class="form_group">
            ...
            <div class="form_group">
                ...
                <input type="text" id="asal_universitas" name="asal_universitas" value="<?= $data['asal_univ'] ?? '' ?>" placeholder="">
            </div>
            <div class="form_group">
