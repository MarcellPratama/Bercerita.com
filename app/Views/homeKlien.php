                    ...
                    <li class="nav-item">
                        <a href="/beranda" class="nav-link">
                            <svg width="32" height="32" viewBox="0 0 40 37" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M29.1667 12.3125L19.7917 2.93747L5.02083 17.7083H8.33333V34.375H14.5833V21.875H25V34.375H31.25V17.7083H34.5625L31.25 14.3958V7.29164H29.1667V12.3125ZM0 19.7916L19.7917 -3.05176e-05L27.0833 7.29164V5.2083H33.3333V13.5416L39.5833 19.7916H33.3333V36.4583H22.9167V23.9583H16.6667V36.4583H6.25V19.7916H0Z"
                                    fill="black" />
                            </svg> Beranda
                        </a>
                    </li>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-overlay" id="beranda">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <button class="nav-link" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebar"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p>Burnout adalah kondisi kelelahan fisik, emosional, dan mental akibat tekanan pekerjaan atau
                            tanggung jawab berlebih.
                            Tanda-tanda burnout termasuk kelelahan ekstrem, kehilangan motivasi, dan merasa tidak
                            produktif meski telah bekerja keras.
                            Dengan mengenali gejalanya lebih awal, kita bisa mengambil langkah-langkah seperti
                            istirahat, menjaga keseimbangan hidup,
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p>Kesepian adalah pengalaman emosional yang dapat dialami oleh siapa saja, meskipun dikelilingi
                            oleh orang lain.
                            Hal ini dapat timbul dari perasaan terputus dari lingkungan sosial, kehilangan koneksi
                            dengan teman, atau
                            bahkan ketidakmampuan untuk berkomunikasi dengan orang lain. Mempelajari kesepian penting
                            untuk memahami dampaknya
                            terhadap kesehatan mental dan fisik kita, serta mencari cara untuk mengatasinya melalui
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p>Kecemasan adalah perasaan ketakutan atau kekhawatiran yang sering muncul tanpa alasan yang
                            jelas.
                            Ini bisa membuat seseorang merasa gelisah, tegang, atau khawatir tentang hal-hal
                            sehari-hari.
                            Meskipun kecemasan adalah respons normal terhadap stres, jika berlebihan, bisa mengganggu
                            kehidupan sehari-hari.
                            Memahami kecemasan penting untuk mengenali gejalanya dan mencari bantuan, sehingga kita
                            dapat mengelola
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p>Frustrasi adalah perasaan kesal atau kecewa yang muncul ketika sesuatu tidak berjalan sesuai
                            harapan.
                            Hal ini bisa disebabkan oleh berbagai hal, seperti kegagalan mencapai tujuan atau hambatan
                            yang muncul dalam perjalanan hidup.
                            Frustrasi adalah emosi yang normal, tetapi jika tidak dikelola dengan baik, dapat
                            memengaruhi kesehatan mental dan fisik.
                            Memahami frustrasi dapat membantu kita menemukan cara untuk tetap tenang, bersabar, dan
                            mencari solusi yang lebih efektif.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p>Trauma adalah respons emosional terhadap peristiwa yang sangat mengejutkan atau menyakitkan,
                            seperti kecelakaan,
                            kekerasan, atau kehilangan. Pengalaman ini bisa meninggalkan bekas yang mendalam dan
                            mempengaruhi cara seseorang
                            memandang dunia serta dirinya sendiri. Trauma tidak selalu terlihat dari luar, namun dapat
                            berdampak jangka panjang
                            pada kesehatan mental dan fisik. Memahami trauma adalah langkah penting untuk proses
                            penyembuhan dan menemukan
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p>Putus asa adalah perasaan kehilangan harapan atau keyakinan bahwa keadaan akan membaik.
                            ...
                            bisa sangat menyakitkan, ada cara untuk menemukan kembali harapan dengan dukungan dan
                            langkah-langkah
                            kecil menuju pemulihan.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="<?= base_url('images/Family & Relation.png') ?>" alt="Family & Relation"
                        class="d-block w-100">
                    <div class="carousel-caption">
                        <h3>Keluarga & Hubungan: Fondasi Penting dalam Kehidupan</h3>
                        <p>Keluarga dan hubungan merupakan pilar utama yang memberikan dukungan emosional, rasa aman,
                            dan kebahagiaan dalam hidup.
                            Hubungan yang sehat dalam keluarga dan dengan orang lain membantu seseorang merasa dihargai
                            dan dicintai.
                            Namun, seperti halnya semua hubungan, tantangan dan konflik bisa terjadi.
                            Memahami pentingnya komunikasi yang baik, empati, dan saling pengertian adalah kunci untuk
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p>Cemburu adalah emosi yang muncul ketika seseorang merasa takut kehilangan perhatian, cinta,
                            atau kedudukan karena orang lain.
                            Perasaan ini bisa timbul dalam berbagai hubungan, baik itu pertemanan, keluarga, atau
                            percintaan.
                            Meskipun wajar, cemburu yang berlebihan dapat merusak kepercayaan dan hubungan yang sehat.
                            Memahami cemburu membantu kita mengelola emosi ini dengan lebih baik dan memperkuat rasa
                            percaya diri serta hubungan yang kita miliki.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between">
                <div class="row mt-3">
                    <div class="col-md-7">
                        <div class="body-text">
                            <p>
                                Bercerita.com adalah platform digital yang mendukung kesehatan mental, khususnya bagi
                                kaum muda.
                                Kami menyediakan ruang aman dan anonim untuk berbagi cerita atau mencari dukungan,
                                dengan fitur konsultasi bersama psikolog profesional dan forum diskusi mahasiswa
                                psikologi.
                                Layanan kami mencakup chat pribadi dengan psikolog, penjadwalan konsultasi luring,
                                serta Mading Notes Digital untuk mencatat perasaan secara bebas dalam perjalanan menuju
