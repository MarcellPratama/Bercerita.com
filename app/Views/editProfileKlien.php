...
<body>
                ...
                <div class="row">
                    <div class="col-md-4 d-flex justify-content-center align-items-center">
                        <div class="profile-picture">
                            <!-- Gambar Profil -->
                            <img id="profilePicturePreview" src="<?= base_url($userData['foto']) ?>" alt="Foto Profil" class="rounded-circle" onclick="triggerFileInput()">
                            <!-- Overlay dengan Ikon Edit -->
                            <button type="button" class="overlay text-decoration-none" onclick="triggerFileInput()">
                            ...
                            <input type="file" id="profilePictureInput" name="profile_picture" accept="image/*" class="d-none" onchange="previewImage(event)">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="mb-3">
                            <label for="username" class="form-label">Nama Pengguna</label>
                            <input type="text" class="form-control" id="username" name="username" placeholder="Masukkan nama pengguna" value="<?= ($userData['username']) ?>">
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="password-container">
                                    ...
                                    <span class="password-toggle" onclick="togglePassword('new-password', 'new-password-icon')">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye"
                                            id="new-password-icon" viewBox="0 0 16 16">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="password-container">
                                    <input type="password" class="form-control" id="confirm-password" name="confirm-password" placeholder="Masukkan kata sandi baru">
                                    <span class="password-toggle" onclick="togglePassword('confirm-password', 'confirm-password-icon')">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye"
                                            id="confirm-password-icon" viewBox="0 0 16 16">
                                            <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8a13.133 13.133 0 0 1-1.66 2.043C11.879 11.332 10.12 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.133 13.133 0 0 1 1.172 8z" />
                                            <path d="M8 5a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM8 6a2 2 0 1 1 0 4 2 2 0 0 1 0-4z" />
                                        </svg>
                                    </span>
                                </div>
                                <div id="error-message" class="error-message d-none">Kata sandi tidak cocok!</div>
                            </div>
                        </div>
                        <div class="mb-4">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan email" value="<?= ($userData['email']) ?>">
                        </div>
    ...
    <script>
        ...
        // Fungsi untuk memvalidasi dan menampilkan pratinjau gambar
        function previewImage(event) {
            ...
            if (file && file.type.startsWith('image/')) {
                ...
                alert('Hanya file gambar yang diizinkan! Silakan pilih file gambar.');
        ...
        // Tambahkan event listener untuk memeriksa kecocokan kata sandi secara real-time
